...
const MedievalHouse: React.FC<MedievalHouseProps> = ({ 
  variation = 1, 
  selected = false,
  isSource = false,
  isTarget = false 
  ...
  return (
    ...
    >
      ...
      {variation === 3 && (
        <>
          <line x1="30" y1="50" x2="70" y2="50" stroke="var(--mastil-neutral-dark)" strokeWidth="1" opacity="0.7" />
          <line x1="30" y1="70" x2="70" y2="70" stroke="var(--mastil-neutral-dark)" strokeWidth="1" opacity="0.7" />
        </>
      )}
      {variation === 2 && (
        <line x1="25" y1="55" x2="75" y2="55" stroke="var(--mastil-neutral-dark)" strokeWidth="1" opacity="0.7" />
      )}
